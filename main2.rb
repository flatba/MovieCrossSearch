...
category_url_arr.each do |category_url|
  ...
  for btn_cnt in 0..button_num
    ...
    sleep 10
    puts "[もっと見る]の#{btn_cnt}個目をクリック"
    puts "動画コンテンツ一覧にアクセス..." + @driver.current_url
    sleep 10
    ...
    begin
      ...
      for content_btn_cnt in 0..contents_num
        ...
        contents = main.newContents(@driver, content_doc)
